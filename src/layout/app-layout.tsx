...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiTag, FiFlag } from 'react-icons/fi';
...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Newsletter', path: '/newsletters', entity: 'newsletter', service: AccessServiceEnum.PROJECT, icon: FiMail },
